...
Data_dict = {'kfw1': kfw_dataset, 'kfw2': kfw_dataset, 'fiw': fiw_dataset, 'nemo': nemo_image_dataset, 'nemo_age': nemo_image_dataset_age,
             'nemo_age_age': nemo_image_dataset_age_age,
             'nemo_img':nemo_image_dataset2,'ytf':Youtube_Faces_DB,
...
mats_dict = {'kfw1':['fd', 'fs', 'md', 'ms'],
             ...
             'nemo_age':['F-D','F-S','M-D','M-S','B-B','B-S','S-S'],
             'nemo_age_age':['F-D','F-S','M-D','M-S','B-B','B-S','S-S'],
...
imgs_dict = {'kfw1':{'fd':'father-dau', 'fs':'father-son', 'md':'mother-dau', 'ms':'mother-son'},
             ...
             'nemo_age':{'F-D':'F-D','F-S':'F-S','M-D':'M-D','M-S':'M-S','B-B':'B-B','B-S':'B-S','S-S':'S-S'},
             'nemo_age_age':{'F-D':'F-D','F-S':'F-S','M-D':'M-D','M-S':'M-S','B-B':'B-B','B-S':'B-S','S-S':'S-S'},
             'nemo_img':{'F-D':'F-D','F-S':'F-S','M-D':'M-D','M-S':'M-S','B-B':'B-B','B-S':'B-S','S-S':'S-S'},
             'kfw1_identification':[],
             'kfw2_identification':[]
             }

label_type = {'kfw1':'_pairs.mat','kfw2':'_pairs.mat','fiw':'.pkl','nemo':'.pkl','nemo_img':'.pkl','nemo_age':'.pkl','nemo_age_age':'.pkl',
...
mat_pth_dict = {'kfw1': '/var/scratch/CODE/transformer/transformer-kin/data/KinFaceW-I/meta_data',
                ...
                'nemo_age':'/local/Nemo/label/train_list',
                'nemo_age_age':'/local/Nemo/label/train_list',
                'nemo_img':'/local/Nemo/label/train_list',
                'kfw1_identification':
                ['/home/wwang/CODE/transformer/transformer-kin/data/KinFaceW-I/meta_data/fd_pairs.mat',
                ...
                'kfw2_identification':
                ['/home/wwang/CODE/transformer/transformer-kin/data/KinFaceW-II/meta_data/fd_pairs.mat',
                '/home/wwang/CODE/transformer/transformer-kin/data/KinFaceW-II/meta_data/fs_pairs.mat',
                '/home/wwang/CODE/transformer/transformer-kin/data/KinFaceW-II/meta_data/md_pairs.mat',
                '/home/wwang/CODE/transformer/transformer-kin/data/KinFaceW-II/meta_data/ms_pairs.mat']
                }
...
im_root_dict = {'kfw1':'/var/scratch/CODE/transformer/transformer-kin/data/KinFaceW-I/images',
                ...
                'nemo_age':'/local/Nemo/kin_simple/frames/',
                'nemo_age_age':'/local/Nemo/kin_simple/frames/',
                'nemo_img':'/local/Nemo/kin_simple/frames/',
                'kfw1_identification':
                ['/home/wwang/CODE/transformer/transformer-kin/data/KinFaceW-I/images/father-dau',
                ...
                'kfw2_identification':
                ['/home/wwang/CODE/transformer/transformer-kin/data/KinFaceW-II/images/father-dau',
                '/home/wwang/CODE/transformer/transformer-kin/data/KinFaceW-II/images/father-son',
                '/home/wwang/CODE/transformer/transformer-kin/data/KinFaceW-II/images/mother-dau',
                '/home/wwang/CODE/transformer/transformer-kin/data/KinFaceW-II/images/mother-son'],
                }
...
def get_trans_train(name, expand_dim = False):
    ...
    if 'age' in name:
        return Video_age_Transformations(video_transform_train_age,n_views=1)
...
def get_trans_test(name, expand_dim = False):
    ...
    if 'age' in name:
        return Video_age_Transformations(video_transform_train_age_test,n_views=1,test=True)
    if ('video' in name) or ('nemo' in name):
